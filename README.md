<div align="center">
 ...
 <!-- Header Section -->
 <h1>👨‍💻 Sahitya Singh</h1>
 <h3><i>Digital Explorer & Open Source Enthusiast</i></h3>

 <!-- Social Badges -->
 <p>
   <a href="https://github.com/Sahitya0805">
     <img src="https://img.shields.io/github/followers/Sahitya0805?label=Followers&style=for-the-badge&color=00ff00&logo=github&logoColor=black" />
   </a>
   <a href="https://github.com/Sahitya0805">
     <img src="https://img.shields.io/github/stars/Sahitya0805?style=for-the-badge&color=00ff00&label=Stars&logo=github&logoColor=black" />
   </a>
 </p>

 <br>

 <!-- Bio Section using styled table for alignment -->
 <table align="center" style="border: none;">
  <tr>
   <td align="left" width="60%">
    <h3>🚀 About Me</h3>
    <ul style="list-style-type: none;">
     <li>💻 <b>Tech Stack:</b> Python, Java, JavaScript, C++</li>
     <li>🏫 <b>Studying:</b> 1st Year @ NST Bengaluru</li>
     <li>🤖 <b>Interests:</b> Machine Learning, OpenCV, Automation</li>
     <li>⚡ <b>Motto:</b> <i>"Dream -> Build -> Repeat"</i></li>
    </ul>
   </td>
